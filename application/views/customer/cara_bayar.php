  	...
  	<div class="breadcumb-area" style="background-image: <?php echo site_url('img/bg-img/breadcumb.jpg');?>">
    	...
    	<section class="archive-area section_padding_80">
    	    <div class="container">
				...
				<h3>2. Lihat detail untuk melihat games apa yang anda beli</h3>
				...
				<h3>9. Pesanan anda akan di proses oleh admin dan anda akan dihubungi oleh admin kami melalui telpon dan e-mail</h3>
				<h3>&nbsp;</h3>
        	</div>
    	</section>
